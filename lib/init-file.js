...
export default {
    ...
    initialize(state) {
      this.disposable = atom.workspace.onDidAddTextEditor( editor => {
        let ochangeTitle= editor.textEditor.onDidChangeTitle(()=> {
          this.initVue(editor.textEditor);
        })
        editor.textEditor.onDidDestroy(()=> {
